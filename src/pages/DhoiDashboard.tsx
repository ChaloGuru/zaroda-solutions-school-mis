  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-background">
      ...
      <main className="container-max section-padding flex flex-col items-center justify-center min-h-[60vh]">
        ...
        <h1 className="text-3xl font-bold mb-2">DHOI Dashboard</h1>
        <p className="text-muted-foreground text-center max-w-md">
          This dashboard is under construction. Features for Deputy Head of Institution will be available soon.
        </p>
      </main>
    </div>
  );
